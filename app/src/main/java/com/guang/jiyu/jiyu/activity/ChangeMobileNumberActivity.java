...
public class ChangeMobileNumberActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setView(R.layout.activity_change_mobile_num);
        initTitle();
        initData();
    }
    ...
    private void initTitle() {
        ...
        titlebar.addAction(new TitleBar.TextAction("下一步") {
            @Override
            public void performAction(View view) {
                ActivityUtils.startActivity(ChangeMobileNumberActivity.this,BindNewMobileActivity.class);
            }
        });
    }
