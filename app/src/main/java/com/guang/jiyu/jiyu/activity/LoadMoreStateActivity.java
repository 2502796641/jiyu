...
public class LoadMoreStateActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setView(R.layout.activity_loadmore_state);
        handler = new Handler();
        initData();
        initTitle();
        initBottomView();
    ...
    private void initBottomView() {
        ...
        loadMore.setOnClickListener(new LoadMoreStateActivity.ButtonClickListener());
    ...
    private void initTitle() {
        TitleBarUtils.setTitleBarWithImg(this, titlebar, "最新动态", R.mipmap.icon_return_with_txt);
    ...
    public void initData() {
        ...
        adapter = new LoadMoreAdapter(datas, this, Contants.TAG_LOADMORE_STATE);
    }
