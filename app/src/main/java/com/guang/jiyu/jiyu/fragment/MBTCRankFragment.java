...
public class MBTCRankFragment extends BaseFragment{
    ...
    public int getLayoutID() {
        return R.layout.fragment_mbtc_rank;
    }
    ...
    private void initBottomView() {
        ...
        loadMore.setOnClickListener(new MBTCRankFragment.ButtonClickListener());
