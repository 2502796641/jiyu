...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mRightLayout.setPadding(mOutPadding, mOutPadding, mOutPadding, 0);
        //mRightLayout.setPaddingRelative();
    ...
    public void setLeftImageResource(int resId) {
        ...
        drawable.setBounds(0,0,150,60);
        mLeftText.setCompoundDrawables(drawable,null,null,null);
    }

    public void setLeftImageResourceSpeacial(int resId) {
        //mLeftText.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        Drawable drawable = getResources().getDrawable(resId);
...
/*        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    public abstract static class ImageAction implements Action {
